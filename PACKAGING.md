...
- Windows 単体 launcher: `ASEappSurfaceBuilder-1.1.1-Windows.exe`
- Windows ZIP: `ASEappSurfaceBuilder-1.1.1-Windows.zip`
- Linux: `ASEappSurfaceBuilder-1.1.1-Linux.tar.gz`
- macOS: `ASEappSurfaceBuilder-1.1.1-macOS.dmg`（macOS 上で再ビルドした場合）
...
```text
standalone_exe/windows/ASEappSurfaceBuilder-1.1.1-Windows.exe
```

現在このリポジトリに同梱している Windows 版は `standalone_exe/windows/ASEappSurfaceBuilder-1.1.1-Windows.exe` です。互換確認用として `standalone_exe/windows/ASEappSurfaceBuilder-1.1.0-Windows.exe` と `standalone_exe/windows/ASEappSurfaceBuilder-1.0.0-Windows.exe` も残しています。
...
```powershell
$zip = (Resolve-Path 'code/native_ui/dist/ASEappSurfaceBuilder-1.1.1-Windows.zip').Path
