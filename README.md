...
このリポジトリに含まれる配布物は次の場所にあります。

| OS | 直接ダウンロード | 推奨形式 |
| --- | --- | --- |
| Windows | [ASEappSurfaceBuilder-1.0.0-Windows.exe](https://github.com/ic191226/ASEappSurfaceBuilder/raw/main/standalone_exe/windows/ASEappSurfaceBuilder-1.0.0-Windows.exe) | 単体 `.exe` |
| macOS | [ASEappSurfaceBuilder-1.0.0-macOS.dmg](https://github.com/ic191226/ASEappSurfaceBuilder/raw/main/standalone_exe/macos/ASEappSurfaceBuilder-1.0.0-macOS.dmg) | `.dmg` |
...
macOS 版はこのリポジトリの `standalone_exe/macos/` からダウンロードして開けます。

```bash
curl -L -o ASEappSurfaceBuilder-1.0.0-macOS.dmg \
  https://github.com/ic191226/ASEappSurfaceBuilder/raw/main/standalone_exe/macos/ASEappSurfaceBuilder-1.0.0-macOS.dmg
...
Windows は `standalone_exe/windows/`、macOS は `standalone_exe/macos/` に完成済み配布物を置きます。ソースから使う場合は次の手順で環境を作ってください。
